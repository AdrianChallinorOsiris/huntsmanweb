    ...
    <div class="container mx-auto px-4 max-w-3xl">
      ...
      <div class="prose prose-slate max-w-none">
        ...
        <p class="text-lg text-slate-600">
          ...
          restricted to use as a sports ground, it imposed a number of restrictions including banning cars and other 
          motorised vehicles (apart from mobility scooters) from entering or exiting via the Cator Estate, 
          in order to protect the tranquil nature of the estate. And it imposed restrictions on the development 
          in order to protect the privacy of houses neighbouring the Huntsman, which was threatened by the proposals. <i>
        ...
        <p class="text-lg text-slate-600">
          ...
          communal amenity, which enhances the surrounding context and mediates between Kidbrooke Village and 
